...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private PikachuUserDetailService userDetailService;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        // 对自己编写的 UserDetailsService 进一步包装，实现缓存
     ...
     */
    private CachingUserDetailsService cachingUserDetailsService(UserDetailsService userDetailsService) {
        ...
        return BeanUtils.instantiateClass(ctor, userDetailsService);
    }
